...
public class ICount {
    ...
    private static synchronized void appendToFile(String path) 
        throws IOException {
            String str = i_count + " instructions in " + b_count + " basic blocks were executed in " + m_count + " methods.";
    ...
    private static synchronized void writeToFile(String path) 
        throws IOException {
            String str = i_count + " instructions in " + b_count + " basic blocks were executed in " + m_count + " methods.";
    ...
    public static synchronized void printICount(String foo) {
        String path = "metrics/icount.txt";
